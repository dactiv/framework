...
public class SignTaskListFilterMetadata implements Serializable {

    @Serial
    private static final long serialVersionUID = 7297763795565312743L;
    ...
    public SignTaskListFilterMetadata() {
    }
