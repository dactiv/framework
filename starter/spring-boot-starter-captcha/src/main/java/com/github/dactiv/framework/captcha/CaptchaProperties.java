...
public class CaptchaProperties {
     ...
     * 验证码 token 缓存配置
     */
    private CacheProperties buildTokenCache = CacheProperties.of("dactiv:captcha:build-token:", TimeProperties.ofMinutes(5));
    /**
     * 拦截器 token 缓存配置
     */
    private CacheProperties interceptorTokenCache = CacheProperties.of("dactiv:captcha:interceptor-token:", TimeProperties.ofMinutes(5));
